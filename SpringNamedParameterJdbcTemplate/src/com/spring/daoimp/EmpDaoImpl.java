...
public class EmpDaoImpl implements EmpDao {
	...
	public Employee getEmployeeById(int empId) {
         String Sql="select * from venkats.EMPLOYEE_TABLE where emp_id=:empId";
         /*Map<String,Integer> empMap=new HashMap<String,Integer>();
         empMap.put("empId", 6);*/
         MapSqlParameterSource empMap=new MapSqlParameterSource();
         empMap.addValue("empId", 6);
		return namedParameterJdbcTemplate.queryForObject(Sql, empMap, new EmpRowMapper());
				//queryForObject(Sql, new EmpRowMapper(), empId);
	}
	...
	public List<Employee> getEmpInfo() {
		...
		return null;//jdbcTemplate.query(Sql, new EmpRowMapper());
	}
	...
	public void createEmployee(Employee emp) {
		...
		try {
			...
			if (update > 0) {
				System.out.println("emp data inserted in db==="+emp.getEmpName());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
